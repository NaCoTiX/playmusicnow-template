    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div>
            <h3 style={{ color: colors.primary, margin: 0, marginBottom: '0.5rem' }}>
              🌟 Share SpotMusic.xyz
            </h3>
            <p style={{ color: colors.textSecondary, margin: 0, fontSize: '0.9rem' }}>
              Help others discover collaborative music playlists!
            </p>
          </div>
        </div>
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <button 
              onClick={() => {
                ...
                alert('SpotMusic.xyz link copied to clipboard!')
              }}
              style={{
          ...
          <div style={{ 
            ...
            <span style={{ color: colors.text, marginRight: '0.5rem', fontSize: '0.9rem' }}>
              Quick Share:
            </span>
            <button 
              onClick={() => {
                const text = `Check out SpotMusic.xyz - Create collaborative playlists that anyone can contribute to! 🎵 ${window.location.origin}`
        ...
        <div style={{ 
          ...
          <h4 style={{ color: colors.text, margin: '0 0 0.5rem 0', fontSize: '0.9rem' }}>
            ✨ Why share SpotMusic.xyz?
          </h4>
          <ul style={{ 
            ...
            <li>Help friends discover new music through collaborative playlists</li>
            <li>Build a community of music lovers who contribute songs</li>
            <li>Make parties and events more interactive with shared playlists</li>
          </ul>
        </div>
      </div>
